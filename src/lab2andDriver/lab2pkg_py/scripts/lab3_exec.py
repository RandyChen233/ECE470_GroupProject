...
# s1 = np.zeros((4,4))
# s1[0:3,:]=np.hstack([hat(w1),v1.reshape(-1,1)])

# s2 = np.zeros((4,4))
# s2[0:3,:]=np.hstack([hat(w2),v2.reshape(-1,1)])

# s3 = np.zeros((4,4))
# s3[0:3,:]=np.hstack([hat(w3),v3.reshape(-1,1)])

# s4 = np.zeros((4,4))
# s4[0:3,:]=np.hstack([hat(w4),v4.reshape(-1,1)])

# s5 = np.zeros((4,4))
# s5[0:3,:]=np.hstack([hat(w5),v5.reshape(-1,1)])

# s6 = np.zeros((4,4))
# s6[0:3,:]=np.hstack([hat(w6),v6.reshape(-1,1)])
